...
const dict = {
  ...
  'vllm.enableReasoning': { ja: '推論', en: 'Reasoning' },
  'vllm.enableReasoningDesc': { ja: 'vLLM モデルの thinking/reasoning 機能を有効化します', en: 'Enable thinking/reasoning for vLLM models' },
  'vllm.enableReasoningOn': { ja: 'オン', en: 'On' },
  'vllm.enableReasoningOff': { ja: 'オフ', en: 'Off' },
